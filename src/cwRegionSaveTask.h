...
private:
    ...
    void saveFixedStations(CavewhereProto::FixedStationModel* protoFixedStations,
                           cwFixedStationModel* model);
    void saveFixedStation(CavewhereProto::FixedStation* protoFixedStation,
                          const cwFixedStation& station);
