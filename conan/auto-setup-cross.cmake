...
macro(qtc_auto_setup_conan)
  ...
  if (conanfile_txt AND NOT QT_CREATOR_SKIP_CONAN_SETUP)
      ...
      file(WRITE "${CMAKE_BINARY_DIR}/conan-dependencies/CMakeLists.txt" "
        ...
        if (${conan_version} VERSION_GREATER_EQUAL 2.0)
          ...
          file(APPEND \"${CMAKE_BINARY_DIR}/conan-dependencies/conan_host_profile\"
              \"tools.cmake.cmaketoolchain:user_toolchain+=${CMAKE_SOURCE_DIR}/conan/conan_host_extra_vars.cmake\\n\"
          )
    ...
    include("${CMAKE_BINARY_DIR}/conan-dependencies/build/conan/conan_toolchain.cmake")
  endif()
  unset(conanfile_txt)
endmacro()
