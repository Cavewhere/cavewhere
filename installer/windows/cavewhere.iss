...
OutputDir=C:\windowsBuild\cavewhere\installer\windows\output
...
[Files]
Source: "..\..\release\Cavewhere.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\release\plotsauce.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\release\cavern.exe"; DestDir: "{app}"; Flags: ignoreversion
