...
AppId={{9A964957-5F6C-48C3-9780-7D11A8B858DD}
AppName={#MyAppName}
...
Filename: "{tmp}\{#MyRedistributableExe}"; Check: VCRedistNeedsInstall
...
begin
  ...
  Result := not (VCVersionInstalled({#MyRedistributableVersion}));
end;
