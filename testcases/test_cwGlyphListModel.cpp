...
TEST_CASE("cwGlyphListModel tracks object-first glyph edits on a forked palette",
          "[cwGlyphListModel]")
{
    ...
    palette->setGlyph(makeGlyph(QStringLiteral("zzz-new"), QStringLiteral("Zzz New"), 1));
    ...
    palette->removeGlyph(QStringLiteral("zzz-new"));
