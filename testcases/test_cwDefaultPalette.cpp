...
//
// The files are produced from create() so nobody hand-edits serialized JSON; a
// drift-guard test (added later) asserts the committed qrc files still equal what
// create() produces.
