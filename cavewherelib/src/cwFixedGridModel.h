...
#ifndef CWFIXEDGRIDMODEL_H
#define CWFIXEDGRIDMODEL_H
...
class CAVEWHERE_LIB_EXPORT cwFixedGridModel : public cwAbstractSketchPainterPathModel
{
    ...
    Q_PROPERTY(cwGridTextModel* textModel READ textModel CONSTANT)
...
public:
    ...
    void   setLabelBackgroundMargin(const double &value) { m_labelBackgroundMargin = value; }
    ...
    void   setLabelScale(double scale) { m_labelScale = scale; }
    QBindable<double> bindableLabelScale() { return &m_labelScale; }

    // Same map units as gridInterval(). Grid lines at this interval are omitted
    // so a coarser grid can be drawn on top without duplicate lines.
    double hiddenInterval() const { return m_hiddenInterval.value(); }
    void   setHiddenInterval(const double &value) { m_hiddenInterval = value; }
...
private:
    ...
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, double, m_lineWidth, 1.0, &cwFixedGridModel::lineWidthChanged)
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, QColor, m_lineColor, QColor(0xCC, 0xCC, 0xCC), &cwFixedGridModel::lineColorChanged)

    Q_OBJECT_BINDABLE_PROPERTY(cwFixedGridModel, QMatrix4x4, m_mapMatrix, &cwFixedGridModel::mapMatrixChanged)
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, QRectF,  m_viewport, QRectF(), &cwFixedGridModel::viewportChanged)
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, QPointF, m_origin, QPointF(), &cwFixedGridModel::originChanged);

    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, bool,   m_labelVisible, true, &cwFixedGridModel::labelVisibleChanged)
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, QColor, m_labelColor, QColor(0x88, 0x88, 0x88), &cwFixedGridModel::labelColorChanged)
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, QFont,  m_labelFont, QFont(), &cwFixedGridModel::labelFontChanged)
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, double, m_labelBackgroundMargin, 2.0, &cwFixedGridModel::labelBackgroundMarginChanged);
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, QColor, m_labelBackgroundColor, Qt::white, &cwFixedGridModel::labelBackgroundColorChanged);
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, double, m_labelScale, 1.0, &cwFixedGridModel::labelScaleChanged);
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, double, m_hiddenInterval, 0.0, &cwFixedGridModel::hiddenIntervalChanged);

    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, QList<QRectF>, m_labelMasks, QList<QRectF>(), &cwFixedGridModel::labelMasksChanged);

    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, double, m_gridZ, 0.0, &cwFixedGridModel::gridZChanged);
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, double, m_labelBackgroundZ, 0.0, &cwFixedGridModel::labelBackgroundZChanged);
    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, double, m_labelZ, 0.0, &cwFixedGridModel::labelZChanged);

    Q_OBJECT_BINDABLE_PROPERTY_WITH_ARGS(cwFixedGridModel, double, m_gridIntervalPixels, 0.0, &cwFixedGridModel::gridIntervalPixelsChanged);
    ...
    struct GridLabel {
        ...
        bool operator!=(const GridLabel &other) const { return !(*this == other); }
    };

    double gridIntervalLength() const;
    Q_OBJECT_COMPUTED_PROPERTY(cwFixedGridModel, double, m_gridIntervalLength, &cwFixedGridModel::gridIntervalLength);
    ...
    Q_OBJECT_BINDABLE_PROPERTY(cwFixedGridModel, QPainterPath, m_gridPath);

    Q_OBJECT_BINDABLE_PROPERTY(cwFixedGridModel, QVector<GridLabel>, m_gridLabels);
    Q_OBJECT_BINDABLE_PROPERTY(cwFixedGridModel, QVector<cwGridTextModel::TextRow>, m_textRows);

    Q_OBJECT_BINDABLE_PROPERTY(cwFixedGridModel, QPainterPath, m_labelBackgroundPath);
    ...
    cwGridTextModel *m_textModel = nullptr;
};

#endif // CWFIXEDGRIDMODEL_H
