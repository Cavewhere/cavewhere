...
QQ.Item {
    ...
    //ties a station to the shots around it, a shot cell a flat fill
    property bool stationCell: false
    property bool shotCell: false
    ...
    function shouldHaveFocus(): bool {
        ...
        return cell.model.focusedRow === cell.listViewIndex
                && cell.model.focusedRole === cell.dataRole
    }
    ...
    function takeFocus() {
        ...
        cell.model.setFocusedCell(cell.model.cellIndex(cell.listViewIndex, cell.dataRole))
    }

    function moveFocus(navKey: int) {
        const currentCell = cell.model.cellIndex(cell.listViewIndex, cell.dataRole)
    ...
    onDataRoleChanged: cell.syncFocusState()
