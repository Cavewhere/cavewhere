    ...
    sourceComponent: QQ.Component {
        QC.Menu {
            ...
            function stationLabel(index) {
                ...
                let row = shotMenuLoader.model.modelRowForCellRole(
                            dataValue.chunk,
                            index,
            ...
            QC.Menu {
                ...
                QC.MenuItem {
                    ...
                    enabled: dataValue.chunk !== null
                             ...
                             && shotMenuLoader.model.canRemoveShotAt(shotMenuLoader.model.cellIndex(listViewIndex, dataValue.cellRole), SurveyChunk.Above)
                    ...
                    onTriggered: {
                        clearRemovePreview()
                        shotMenuLoader.model.removeShotAt(shotMenuLoader.model.cellIndex(listViewIndex, dataValue.cellRole), SurveyChunk.Above)
                    }
                }
                QC.MenuItem {
                    ...
                    enabled: dataValue.chunk !== null
                             && shotMenuLoader.model !== null
                             && shotMenuLoader.model.canRemoveShotAt(shotMenuLoader.model.cellIndex(listViewIndex, dataValue.cellRole), SurveyChunk.Below)
                    onHighlightedChanged: {
                        if(highlighted) {
                    ...
                    onTriggered: {
                        clearRemovePreview()
                        shotMenuLoader.model.removeShotAt(shotMenuLoader.model.cellIndex(listViewIndex, dataValue.cellRole), SurveyChunk.Below)
                    }
                }
            }
            ...
            QC.Menu {
                ...
                QC.MenuItem {
                    ...
                    enabled: dataValue.chunk !== null
                             && shotMenuLoader.model !== null
                             && shotMenuLoader.model.canInsertShotAt(shotMenuLoader.model.cellIndex(listViewIndex, dataValue.cellRole), SurveyChunk.Above)
                    onTriggered: {
                        shotMenuLoader.model.insertShotAt(shotMenuLoader.model.cellIndex(listViewIndex, dataValue.cellRole), SurveyChunk.Above)
                    }
                }
                ...
                QC.MenuItem {
                    ...
                    enabled: dataValue.chunk !== null
                             && shotMenuLoader.model !== null
                             && shotMenuLoader.model.canInsertShotAt(shotMenuLoader.model.cellIndex(listViewIndex, dataValue.cellRole), SurveyChunk.Below)
                    onTriggered: {
                        shotMenuLoader.model.insertShotAt(shotMenuLoader.model.cellIndex(listViewIndex, dataValue.cellRole), SurveyChunk.Below)
                    }
                }
            }
