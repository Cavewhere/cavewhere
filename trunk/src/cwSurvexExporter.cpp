...
//void cwSurvexExporter::exportCavingRegion(cwCavingRegion* region, QString filename) {

//}

//void cwSurvexExporter::exportCave(cwCave* cave, QString filename) {

//}

//void cwSurvexExporter::exportTrip(cwTrip* trip, QString filename) {
...
//  \brief Set
//  */
//void cwSurvexExporter::setChunks(cwTrip* chunks) {
